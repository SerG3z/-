...
# define N 10000
    ...
    // char output_file[80];
    int success;
    double **u = new double* [M]; // две строки в массиве
    for (int count = 0; count < N; count++)
        u[count] = new double [N]; // и пять столбцов
    double **w = new double* [M]; // две строки в массиве
    for (int count = 0; count < N; count++)
        w[count] = new double [N]; // и пять столбцов
